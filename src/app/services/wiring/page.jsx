...
{activeWire && (
  <div className="fixed inset-0 z-[999] bg-black/90 backdrop-blur-md flex items-center justify-center px-4 overflow-y-auto">
    ...
    <div className="relative w-full max-w-md sm:max-w-6xl bg-white rounded-2xl shadow-2xl overflow-hidden">
      ...
      {/* Top Brand Strip */}
      <div className="bg-gradient-to-r from-amber-600 via-orange-600 to-red-600 px-4 py-2 sm:px-8 sm:py-4 flex items-center justify-between">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-8 p-3 sm:p-10">
        ...
        <div className="flex items-center justify-center">
          <div className="relative bg-gradient-to-br from-yellow-500 to-orange-700 rounded-xl p-4 sm:p-10 shadow-inner w-full">
            <Image
              src={activeWire.img}
              alt={activeWire.name}
              width={300}
        ...
        <div>
          ...
          <div className="mt-3 sm:mt-5 flex flex-wrap items-center gap-1 sm:gap-4">
            <span className="text-xl sm:text-4xl font-extrabold text-orange-600">
              {activeWire.price}
            </span>
          ...
          <div className="mt-4 sm:mt-10 p-3 sm:p-6 bg-gray-50 border rounded-xl flex flex-col sm:flex-row flex-wrap gap-2 sm:gap-3 justify-between">
            <div className="text-xs sm:text-sm text-gray-600 mb-2 sm:mb-0">
              📍 Mudhole Store <br /> ⚡ Wiring & installation available
            </div>

            <div className="flex gap-2 sm:gap-3 flex-wrap">
              <a
                href="tel:9985227139"
                className="px-4 py-2 bg-orange-600 text-white rounded-xl font-semibold hover:bg-orange-700 text-xs sm:text-sm transition"
              >
                📞 Call
              </a>
              <a
