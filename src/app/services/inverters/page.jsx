...
{activeInverter && (
  <div className="fixed inset-0 z-[999] bg-black/90 backdrop-blur-md flex items-center justify-center px-4 overflow-y-auto">
    ...
    <div className="relative w-full max-w-md sm:max-w-6xl bg-white rounded-2xl shadow-2xl overflow-hidden">
      ...
      {/* HEADER */}
      <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 px-4 py-2 sm:px-8 sm:py-4 flex justify-between items-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-10 p-3 sm:p-10">
        ...
        <div className="flex items-center justify-center">
          <div className="relative bg-gradient-to-br from-gray-200 to-gray-400 rounded-xl p-4 sm:p-10 w-full">
            <Image
              src={activeInverter.img}
              alt={activeInverter.name}
              width={300}
              height={200}
              className="rounded-lg w-full max-h-[250px] sm:max-h-[320px] object-contain"
            />
        ...
        <div>
          ...
          <div className="mt-2 sm:mt-6">
            <h3 className="text-sm sm:text-lg font-semibold text-indigo-600 mb-2 sm:mb-3">
              Key Features
            </h3>
          ...
          <div className="mt-3 sm:mt-10 p-3 sm:p-6 bg-gray-50 border rounded-xl flex flex-col sm:flex-row flex-wrap gap-2 sm:gap-3 justify-between">
            <div className="text-xs sm:text-sm text-gray-600 mb-2 sm:mb-0">
              📍 Available at Mudhole Store <br /> ⚡ Installation & battery support available
            </div>
